...
export default function Navbar() {
    return (
            <nav className="flex px-4 justify-between items-center h-12 bg-gradient-to-r from-custom-darkblue via-custom-blue via-20% to-custom-blue to-32% text-white py-4">
                <div className="flex">
